...
var createHref = function () { return 'href'; };
var ExternalLink = function (_a) {
    var baseUrl = _a.baseUrl, urlPath = _a.urlPath, queryObject = _a.queryObject, children = _a.children, _b = _a.blank, blank = _b === void 0 ? true : _b;
    return (react.createElement("a", { href: createHref(baseUrl, urlPath, queryObject), target: blank ? '_blank' : undefined }, children));
};
